...
//import "react-datepicker/dist/react-datepicker.styles";
...
export class Home extends Component<PageProps, PageState> {
  ...
  componentDidMount(){
    //your code
    var ctx: any = (document.getElementById('visitSaleChart') as HTMLCanvasElement).getContext("2d");
  ...
  toggleProBanner() {
    (document.querySelector('.proBanner') as HTMLDivElement).classList.toggle("hide");
  }
                ...
                <div className="card-body">
                  ...
                  <div className="list-wrapper">
                    <ul className="d-flex flex-column todo-list">
                      {this.state.todos.map((todo: any, index: any) =>{
                        return <ListItem
                            isCompleted={todo.isCompleted}
                            changed={(event: any) => this.statusChangedHandler(event, index)}
                            key={todo.id}
